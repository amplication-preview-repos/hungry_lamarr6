...
@InputType()
class AgenceCreateNestedManyWithoutAssociationsInput {
...
export { AgenceCreateNestedManyWithoutAssociationsInput as AgenceCreateNestedManyWithoutAssociationsInput };
